...
/**
 * Extract YouTube URLs — triggered manually from Manage page button.
 */
...
/**
 * Auto-extract YouTube URLs after processing. Returns count.
 */
function autoExtractYouTubeUrls($db)
{
    global $config;
    $assetManager = new AssetManager($config['storage'] ?? array());
    $processor = new Processor($db, $assetManager);
